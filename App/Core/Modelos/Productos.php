...
class Modelos_Productos extends Sfphp_Modelo 
{
	...
	public function get($id = '')
	{
		$where = NULL;
		$query = "SELECT 
			producto, clave, descripcion, descripcionCorta, FORMAT(precio,3) precio, FORMAT(precio2,3) precio2, FORMAT(precio3,3) precio3, FORMAT(precio4,3) precio4,
			unidadMedida, iva, FORMAT(costo,3) costo
		FROM productos ";
		if(trim($id) != "")
